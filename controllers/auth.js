...
const register = async (req, res) => {
    try {
        ...
        res.status(error.status || 500).json({
            error: error.message || "register: Internal Server Error",
        })
    }
}
...
const verifyEmail = async (req, res) => {
    try {
        ...
        res.status(error.status || 500).json({
            error: error.message || "verifyEmail: Internal Server Error",
        })
    }
}
...
const resendVerifyEmail = async (req, res) => {
    try {
        ...
        res.status(error.status || 500).json({
            error: error.message || "resendVerifyEmail: Internal Server Error",
        })
    }
}
...
const login = async (req, res) => {
    try {
        ...
        res.status(error.status || 500).json({
            error: error.message || "login: Internal Server Error",
        })
    }
}
...
const logout = async (req, res) => {
    try {
        ...
        res.status(error.status || 500).json({
            error: error.message || "logout: Internal Server Error",
        })
    }
}
...
const updateUserSubscription = async (req, res) => {
    try {
        ...
        res.status(error.status || 500).json({
            error: error.message || "updateUserSubscription: Internal Server Error",
        })
    }
}
